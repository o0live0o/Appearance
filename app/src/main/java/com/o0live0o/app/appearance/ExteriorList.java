...
public class ExteriorList {
    ...
    public static List<ExteriorBean> getExteriorList(){
        ...
        list.add(new ExteriorBean("1","1.号牌号码/车辆类型",CheckState.PASS));
        list.add(new ExteriorBean("2","2.车辆品牌/型号",CheckState.PASS));
        list.add(new ExteriorBean("3","3.车辆识别代号(或整车出厂编号)",CheckState.PASS));
        list.add(new ExteriorBean("4","4.发动机号码(或电动机号码)",CheckState.PASS));
        list.add(new ExteriorBean("5","5.车身颜色和外形",CheckState.PASS));
        list.add(new ExteriorBean("6","6.外廓尺寸"));
        list.add(new ExteriorBean("7","7.轴距"));
        list.add(new ExteriorBean("8","8.整备质量"));
        list.add(new ExteriorBean("9","9.核定载人数",CheckState.PASS));
        ...
        list.add(new ExteriorBean("16","16.车身外观",CheckState.PASS));
        list.add(new ExteriorBean("17","17.外观标识、标注和标牌",CheckState.PASS));
        list.add(new ExteriorBean("18","18.外部照明和信号灯具",CheckState.PASS));
        list.add(new ExteriorBean("19","19.轮胎",CheckState.PASS));
        list.add(new ExteriorBean("20","20.号牌及号牌安装",CheckState.PASS));
        list.add(new ExteriorBean("21","21.加装/改装灯具",CheckState.PASS));
